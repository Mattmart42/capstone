    ...
    <div className="flex h-full w-full bg-slate-900 overflow-hidden relative selection:bg-transparent">
      ...
      >
        ...
        >
          ...
          {/* Labels */}
          <span className="absolute font-black tracking-widest text-pink-700/40" style={{ left: CENTERS.ik.x, top: -30, transform: `translateX(-50%) scale(${1/zoom})` }}>LOVE</span>
          <span className="absolute font-black tracking-widest text-blue-700/40 -rotate-90 origin-center" style={{ left: -50, top: CENTERS.i.y, transform: `translateY(-50%) scale(${1/zoom})` }}>GOOD AT</span>
          <span className="absolute font-black tracking-widest text-yellow-700/40 rotate-90 origin-center" style={{ right: -70, top: CENTERS.g.y, transform: `translateY(-50%) scale(${1/zoom})` }}>WORLD NEEDS</span>
          <span className="absolute font-black tracking-widest text-emerald-700/40" style={{ left: CENTERS.ai.x, bottom: -30, transform: `translateX(-50%) scale(${1/zoom})` }}>PAID FOR</span>
